...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `You must be at least 16 years old to use TMH. By using the platform, you represent that you meet this age requirement. We do not knowingly collect personal information from users under 16. If you believe a minor has submitted personal information to us, please contact us immediately.`,
  },
  {
    id: "data",
  ...
  },
  {
    ...
    content: `TMH's Share Gate requires users to share a poll to a social network or provide an email address before accessing full results. By engaging with the Share Gate, you agree that: (a) you will not use automated tools, bots, or scripts to bypass the gate, (b) social shares you initiate are your own voluntary act and TMH is not responsible for the content of your posts, (c) emails submitted to unlock results may be added to the TMH newsletter list — you may unsubscribe at any time.`,
  },
  {
    id: "disclaimers",
    title: "9. Disclaimers and Limitation of Liability",
    content: `THE PLATFORM IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. TMH DOES NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF VIRUSES. TO THE MAXIMUM EXTENT PERMITTED BY LAW, TMH AND ITS FOUNDERS, EMPLOYEES, AND AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE PLATFORM. Poll results are non-scientific and represent only the self-selected opinions of platform visitors. They should not be cited as representative surveys or used for academic, commercial, or policy purposes without appropriate caveats.`,
  },
  {
    id: "prohibited",
  ...
  },
  {
    ...
    content: `We reserve the right to modify these Terms at any time. We will notify users of material changes by updating the "Last Updated" date below and, where appropriate, by posting a notice on the platform. Your continued use of TMH after any changes constitutes your acceptance of the new Terms.`,
  },
  {
    id: "contact",
    title: "13. Contact",
    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-wrap gap-6 text-[10px] uppercase tracking-widest font-bold font-serif text-muted-foreground">
          ...
          <a href="/about" className="hover:text-foreground transition-colors">About TMH</a>
